...
use Mactronique\TeleReleve\Compteur\Releve;
use Mactronique\TeleReleve\Storage\StorageChain;
...
EOH
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$storageChain instanceof StorageChain) {
        ...
        for ($day = 0; $day < $daysCount; ++$day) {
            ...
            foreach ($datas as $data) {
                ...
                $releve = Releve::makeFromStorage('CBEMM', $data);
